...
function Residents(){
    const [formData, setFormData] = useState({ firstname: '', middlename: '', lastname: '', suffix: '', sex: '', birthdate: '', maritalStatus: '', nationality: 'Filipino', religion: '', houseNumber: '', purok: '', barangay: 'Tambacan', mobileNumber: '', email: '', isStudent: '', schoolLevel: '', grade: '', school: '', employmentStatus: '', occupation: '', dateStarted: '', monthlyIncome: '', is4Ps: '', isSeniorCitizen: '', isPhilhealthMember: '' });
    ...
    //Issuance of Certifications and etc.
    const [openIssueModal, setopenIssueModal] = useState(false);
    const openingIssueModal = (resident) => {
        setSelectedResident(resident); // Store resident data
        setopenIssueModal(true); // Open modal
    };
    return(
                    ...
                    <tbody>
                        {residentsTable.map((resident) => (
                            <tr key={resident.id}>
                                ...
                                {/*<td>
                                    <p className="text-xl text-primary cursor-pointer" id="residentsviewmore" onClick={() => openingIssueModal(resident)}>Issue</p>
                                </td>
                                <td>
                            ...
                            <div className="modal-content">
                                ...
                                <div className="modal-body">
                                    ...
                                    {currentPage === 4 && (
                                        ...
                                        <div className="input-group input-group-sm mb-3">
                                            <span className="input-group-text" id="basic-addon1">4Ps Beneficiary?</span>
                                            <div class="input-group-text">
                ...
                <>
                    <div className="modal fade show d-block" tabIndex="-1" role="dialog">
                        <div className="modal-dialog">
                            <div className="modal-content">
                                <div className="modal-header">
                                    <h5 className="modal-title">Issuance</h5>
                                    <button type="button" className="btn-close" onClick={() => setopenIssueModal(false)}></button>
                                </div>
                                <div className="modal-body">
                                    <div className="generatetext">
                                    <p className="text-xl text-primary cursor-pointer" id="residentsviewmore">Generate Barangay ID</p>
                                    <p className="text-xl text-primary cursor-pointer" id="residentsviewmore">Generate Certificate of Residency</p>
                                    <p className="text-xl text-primary cursor-pointer" id="residentsviewmore">Generate Certificate of Indigency</p>
                                    </div>

                                    <div class="input-group input-group-sm mb-3">
                                        <span class="input-group-text" id="basic-addon1">Firstname</span>
                                        <input type="text" class="form-control" aria-label="Username" aria-describedby="basic-addon1" required name="firstname" value={selectedResident?.firstname}/>
                                        <span class="input-group-text" id="basic-addon1">Middlename</span>
                                        <input type="text" class="form-control" aria-label="Username" aria-describedby="basic-addon1" require name="middlename" value={selectedResident?.middlename} />
                                    </div>
                                    <div class="input-group input-group-sm mb-3">
                                        <span class="input-group-text" id="basic-addon1">Lastname</span>
                                        <input type="text" class="form-control" aria-label="Username" aria-describedby="basic-addon1" required name="firstname" value={selectedResident?.lastname}/>
                                        <span class="input-group-text" id="basic-addon1">Suffix</span>
                                        <input type="text" class="form-control" aria-label="Username" aria-describedby="basic-addon1" require name="middlename" value={selectedResident?.suffix} />
                                    </div>
                                    <div class="input-group input-group-sm mb-3">
                                        <span class="input-group-text" id="basic-addon1">Birthdate</span>
                                        <input type="text" class="form-control" aria-label="Username" aria-describedby="basic-addon1" required name="firstname" value={selectedResident?.birthdate}/>
                                        <span class="input-group-text" id="basic-addon1">Age</span>
                                        <input type="text" class="form-control" aria-label="Username" aria-describedby="basic-addon1" require name="middlename" value={calculateAge(selectedResident?.birthdate)} />
                                    </div>
